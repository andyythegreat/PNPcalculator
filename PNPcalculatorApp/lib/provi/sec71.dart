...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Sec71Screen(),
    );
  }
}

class Sec71Screen extends StatefulWidget {
  const Sec71Screen({super.key});

  @override
  _Sec71ScreenState createState() => _Sec71ScreenState();
}

class _Sec71ScreenState extends State<Sec71Screen> {
  @override
  Widget build(BuildContext context) {
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        'Uniformed personnel of the Department shall be entitled to a longevity pay of ten percent (10%) of their basic monthly salaries for every five (5) years of service, which shall be reckoned from the date of the personnel`s'
                                            ' original appointment in the AFP, or appointment in the police, fire jail or other allied services to the integration of the PC and the INP: Provided, That the totality of such longevity pay shall not exceed fifty percent (50%) of the basic pay. They shall also continue to enjoy the subsistence allowance, quarters allowance, clothing allowance cost of living allowance, hazard pay, and all other allowances as provided by existing laws.', textAlign: TextAlign.justify,
                                        style: TextStyle(
