...
void main() {
  runApp(const OutrightScreen());
}

class OutrightScreen extends StatefulWidget {
  const OutrightScreen({super.key});

  @override
  _OutrightScreenState createState() => _OutrightScreenState();
}

class _OutrightScreenState extends State<OutrightScreen> {
  @override
